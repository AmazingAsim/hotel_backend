...
export default function Rooms() {
    ...
    let getRoomsInfo = async()=>{ 
        try{
            let result = await axios.get('/rooms/getrooms');
               ...
               <div className='row'> 
                        {
                            rooms.map(function(room){
                                return(
                                    ...
                                    <div className='card P-3 px-3' onClick={()=>{navigate(`../updaterooms/${room.roomId}/${room.available}/${room.guestId?room.guestId:'Null'}/${room.stars}/${room.capacity}`)}} role='button'>
